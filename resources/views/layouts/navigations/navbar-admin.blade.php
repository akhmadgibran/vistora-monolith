    ...
    <div class="max-w-7xl mx-auto flex flex-wrap justify-between items-center px-6 py-4">
        ...
        <div id="navMenu" class="hidden w-full lg:w-auto lg:flex lg:items-center lg:justify-between mt-4 lg:mt-0">
            <ul class="flex flex-col lg:flex-row space-y-2 lg:space-y-0 lg:space-x-6 text-gray-700">
                {{-- <li><a href="{{ route('admin.product.index') }}" class="hover:text-blue-600">Product Management</a></li>
                <li><a href="{{ route('admin.category.index') }}" class="hover:text-blue-600">Category Management</a></li>
                <li><a href="{{ route('admin.shopstatus.index') }}" class="hover:text-blue-600">Shop Status Management</a></li>
                <li><a href="{{ route('admin.order.index') }}" class="hover:text-blue-600">Order Management</a></li>
                <li><a href="{{ route('admin.productpromotion.index') }}" class="hover:text-blue-600">Product Promotion Management</a></li> --}}
            </ul>
            ...
            <ul class="mt-6 lg:mt-0 flex flex-col lg:flex-row items-center space-y-2 lg:space-y-0 lg:space-x-4">
                ...
                @else
                    <li class="relative">
                        ...
                        <div id="userMenu"
                            class="absolute hidden right-0 mt-2 w-40 bg-white border border-gray-200 rounded shadow-md z-50">
